...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert({ schema: 'cd', tableName: 'products' }, [
      { product_id: productIds[0], name: 'Smartphone X200', image_url: '/images/phones/x200.jpg', description: 'Smartphone de última generación con 256GB', buy_price: 8000.00000000, sell_price: 10999.00000000, min_gain_percentage: 25, in_existance: 50, is_active: true, created_at: now, updated_at: now },
      { product_id: productIds[1], name: 'Laptop Pro 15"', image_url: '/images/laptops/pro15.jpg', description: 'Laptop profesional con 16GB RAM y 512GB SSD', buy_price: 15000.00000000, sell_price: 19999.00000000, min_gain_percentage: 20, in_existance: 20, is_active: true, created_at: now, updated_at: now },
      { product_id: productIds[2], name: 'Auriculares Bluetooth', image_url: '/images/audio/bt-headphones.jpg', description: 'Auriculares inalámbricos con cancelación de ruido', buy_price: 800.00000000, sell_price: 1499.00000000, min_gain_percentage: 30, in_existance: 100, is_active: true, created_at: now, updated_at: now },
      { product_id: productIds[3], name: 'Lámpara LED Escritorio', image_url: '/images/hogar/lampara-led.jpg', description: 'Lámpara LED ajustable con puerto USB', buy_price: 250.00000000, sell_price: 499.00000000, min_gain_percentage: 35, in_existance: 80, is_active: true, created_at: now, updated_at: now },
      { product_id: productIds[4], name: 'Camiseta Algodón Premium', image_url: '/images/ropa/camiseta-premium.jpg', description: 'Camiseta de algodón orgánico, varios colores', buy_price: 150.00000000, sell_price: 349.00000000, min_gain_percentage: 40, in_existance: 200, is_active: true, created_at: now, updated_at: now },
      { product_id: productIds[5], name: 'Tablet Infantil', image_url: '/images/tablets/kids-tablet.jpg', description: 'Tablet educativa para niños con control parental', buy_price: 2000.00000000, sell_price: 3299.00000000, min_gain_percentage: 25, in_existance: 0, is_active: false, created_at: now, updated_at: now },
    ]);
