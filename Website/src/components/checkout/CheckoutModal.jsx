...
function DniInput({ value, onChange }) {
  ...
  return (
    <div className="checkout-dni-segments" onClick={handleContainerClick}>
      <input ref={ref1} type="text" inputMode="numeric" maxLength={4} className="checkout-dni-seg"
        value={seg1} onChange={e => updateSeg(0, e.target.value)} onKeyDown={e => handleKeyDown(e, null)} />
      <span className="checkout-dni-sep">–</span>
      <input ref={ref2} type="text" inputMode="numeric" maxLength={4} className="checkout-dni-seg"
        value={seg2} onChange={e => updateSeg(1, e.target.value)} onKeyDown={e => handleKeyDown(e, ref1)} />
      <span className="checkout-dni-sep">–</span>
      <input ref={ref3} type="text" inputMode="numeric" maxLength={5} className="checkout-dni-seg checkout-dni-seg--last"
